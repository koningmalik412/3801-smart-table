        ...
        <div class="w-4/6 p-4">
          <div className="flex h-[270px] gap-4">
            <Link to="/calendar" className="w-4/6">
              <div className="h-full p-10 w-full rounded-[30px] border-[3px] border-brown">
                ...
                <p className="text-sm mt-5 mb-2 pt-4 pr-6 ml-7 text-brown font-montserrat">Create and manage schedules, and view the latest events on a timeline.
                Your family can come together, sit down, and discuss schedules collaboratively.
                </p>
              </div>
            </Link>
            <Link to="/profiles" className="w-2/6">
              <div className="h-full p-9 w-full rounded-[30px] border-[3px] border-brown">
                ...
                <p className="text-sm mt-7 mb-2 ml-3 mr-2 text-brown font-montserrat">Manage family members and their details, including adding, editing and deleting.</p>
              </div>
            </Link>
          </div>
          <Link to="/games">
            <div className="h-[200px] w-full bg-pink mt-6 p-10 rounded-[30px] border-[3px] border-brown">
              ...
              <p className="text-sm mt-5 mb-2 ml-7 text-brown font-montserrat "> Use the table as a space to play board games together.</p>
            </div>
          </Link>
        </div>
        <div className="w-2/6 p-4">
          <Link to="/dashboard">
            <div className="h-[495px] w-full p-10 bg-yellow rounded-[30px] border-[3px] border-brown">
              ...
              <p className="text-sm mb-2 mt-10 pt-4 ml-7 mr-7 text-brown font-montserrat"> All important events and dates are posted in the form of post-it-notes, allowing for a quick view of family schedules.
              The display of the notes can be freely customised. 
